...
public class RefundTest {    @Test
    public void testRefundBuilder_ShouldBuildCorrectly() {
        ...
        UUID refundId = UUID.fromString("d4f5e6b7-8c9d-0e1f-2a3b-4c5d6e7f8a90");
        ...
        assertEquals(UUID.fromString("d4f5e6b7-8c9d-0e1f-2a3b-4c5d6e7f8a90"), refund.getId());
    ...
    public void testRefundSetterGetter_ShouldWorkProperly() {
        ...
        payment.setTransactionId(UUID.fromString("d4f5e6b7-8c9d-0e1f-2a3b-4c5d6e7f8a90"));
